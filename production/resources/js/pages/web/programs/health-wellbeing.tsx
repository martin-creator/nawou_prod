...
export default function ProgramPage() {
    return (
        <WebLayout>
            <Head title={'Health and Wellbeing'} />

            <TitleBanner title={'Health and Wellbeing'} />
            ...
            <section className="px-[10px] pt-5 lg:px-[104px] lg:pt-5">
                <blockquote className="border-primary flex flex-col gap-[16px] border-l-[8px] py-5 pl-6">
                    <h2 className="text-secondary scroll-m-20 text-3xl font-semibold tracking-tight lg:text-4xl">Health and Wellbeing</h2>
